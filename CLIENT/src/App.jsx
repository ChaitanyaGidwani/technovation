          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                Hello there we welcome you to the website of our club and we are
                very pleased that you have visit that you have visited this
                website , we are honored by your visit.......
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              {[
                ...
                <Card
                  key={index}
                  className="bg-slate-800 border-slate-700 p-8 text-center"
                >
              ...
              {[
                ...
                >
                  ...
                  <AccordionContent className="text-gray-400">
                    This will be the answer to the relevant question. Following
                    this will be some random text that will be showcased here
                    later after thoughtful consideration. Following this will be
                    some random text that will be showcased here later after
                    thoughtful consideration. Following this will be some random
                    text that will be showcased here later after thoughtful
                    consideration.
                  </AccordionContent>
                </AccordionItem>
              ))}

...
const Footer = () => {
  const socialLinks = [
    {
      name: "Facebook",
      href: "https://www.facebook.com/abestechnovation/",
      icon: (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/technovationabes",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/the-networking-club-abesec/ ",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
        ...
        <div>
          <div className="flex items-center mb-4">
            ...
            />
            <span className="font-bold ml-2">TECHNOVATION</span>
          </div>
          <div className="flex space-x-4 justify-start pl-2.5">
